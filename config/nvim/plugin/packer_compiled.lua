...
_G.packer_plugins = {
  ...
  ["nvim-comment"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/peter/.local/share/nvim/site/pack/packer/opt/nvim-comment",
  ...
  ["nvim-dap-virtual-text"] = {
    ...
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
  ...
  ["onenord.nvim"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  ["vim-dispatch"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/vim-dispatch",
