...
addMapping('n', '<leader>db', require("dap").toggle_breakpoint, { desc = 'Toggle breakpoint' })
...
addMapping('n', '<leader>do', require("dapui").open, { desc = 'Open debug UI' })
...
addMapping('n', '<leader>H', require("harpoon.mark").add_file, { desc = 'Harpoon add file' })
-- i
-- j
...
addMapping('n', '<C-p>', require('telescope.builtin').commands, { desc = 'Run command' })
-- q
